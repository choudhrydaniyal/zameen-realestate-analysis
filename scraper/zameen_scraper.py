...
def scrape_city(page, city, url_template):
    ...
    if os.path.exists(city_file):
        print(f"  WARNING: {city_file} already exists — appending to existing data.")
        print(f"  Delete the file first if you want a fresh scrape.")
    ...
    for page_num in range(1, PAGES_PER_CITY + 1):
        ...
        try:
            ...
            # NOTE: this class name is dynamically generated by Zameen's frontend
            # if scraper returns 0 listings, inspect the page and update this selector
